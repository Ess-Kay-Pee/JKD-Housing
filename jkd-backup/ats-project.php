                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="read inner mt-4">
                                        <a href="residentialPage/ats-project/ats-picturesque" class="btn btn-sm animated-button victoria-two">Read More</a>
                                    </div>
									  <!-- Modal -->
                                </div>
                            </div>
                            <div class="col-md-4 card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="read inner mt-4">
                                        <a href="residentialPage/ats-project/ats-pristine" class="btn btn-sm animated-button victoria-two">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 card ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="read inner mt-4">
                                        <a href="residentialPage/ats-project/ats-pristine-golf-villa" class="btn btn-sm animated-button victoria-two">Read More</a>
                                    </div>
