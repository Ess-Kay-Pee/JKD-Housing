                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="read inner mt-4">
                                        <a href="ats_kabana_high.php" class="btn btn-sm animated-button victoria-two">Read More</a>
                                    </div>
									  <!-- Modal -->
                                </div>
                            </div>
                            <div class="col-md-4 card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="read inner mt-4">
                                        <a href="ats_kinghood.php" class="btn btn-sm animated-button victoria-two">Read More</a>
                                    </div>
                                </div>
                            </div>
